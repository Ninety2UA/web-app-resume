...
- **Projects page** — 6 cards with type badges (Codex Plugin/violet, SaaS Product/emerald, Full-Stack App/sky, Automation Pipeline/amber). "Explore More Projects" CTA links to projects.dbenger.com. Requirements doc at `docs/brainstorms/projects-page-requirements.md`.
