...
- **Fully responsive** — Mobile-first design via Tailwind breakpoints; desktop nav has "How I Built This Web App" pill next to logo; mobile nav shows Experience, Collaboration, Contact + PDF Resume with ebook pill in hero
