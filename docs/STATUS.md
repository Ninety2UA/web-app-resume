...
**All tasks complete through Phase 29. Site code deployed at `2d553ad`; repo at `9543882` (doc-only commits since `2d553ad`, most of them plans/continuity notes for sibling application sites).**
