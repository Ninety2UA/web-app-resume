...
export function HeroSection() {
  ...
  return (
    <section id="top" className="relative min-h-screen flex flex-col justify-center px-4 sm:px-6 pt-20 pb-12 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto w-full">
        ...
        <motion.div
          ...
          className="mt-8 bg-warm-50 border border-warm-200 rounded-2xl p-2 sm:p-6 md:p-8 shadow-card flex items-center justify-center"
        >
